...
class NeuralRanker(AbstractRanker):
    ...
    def get_query_result_list(self, dataset, query):
        ...
        k = np.minimum(10, n_docs)  # ranking no more than 10 docs
    ...
    def get_all_query_result_list(self, dataset):
        ...
        for query in dataset.get_all_querys():
            ...
            docid_score_list = np.flip(docid_score_list[docid_score_list[:, 1].argsort()], 0)  # sorted by score, from top to the bottom
